"""
Atualiza o banco de dados macro_international (dados brutos multi-pais).

Uso:
    uv run python jobs\\update_international.py
...
def main() -> None:
    ...
    logger.info("Iniciando atualizacao macro_international — %d scripts", len(_SCRIPTS))
