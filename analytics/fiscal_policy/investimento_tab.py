...
Cada serie carrega as 4 janelas lado a lado (ver analytics/fiscal_policy/transforms.py):
...
analytics/credit/ e a aba DLSP ja usam.
...
analytics/fiscal_policy/CLAUDE.md), porque a variacao de um acumulado mede a
...
def build(raw: dict, ipca_pct: dict, pib_mensal: dict, pib_acum_12m: dict) -> dict:
    ...
    linha vazia na tabela (o bug que analytics/labor_market/CLAUDE.md documenta ter
