...
analytics/fiscal_policy/reference/rtn_vs_efgg.md para a diferenciacao completa das
...
Bruto/Trimestral/Acumulado -- ver analytics/fiscal_policy/transforms.py): Bruto reusa
analytics.credit.transforms.compute_variants() (STL mensal period=12, mesma convencao ja
...
analytics.fiscal_policy.transforms.compute_variants_monthly_ttm() (janela TTM de 12
...
comparavel a `despesa_total` (ver Gotchas em analytics/fiscal_policy/CLAUDE.md, "RTN's
...
def build(raw: dict, ipca_pct: dict, pib_acum_12m: dict, pib_mensal: dict) -> dict:
    ...
    """
    from analytics.credit import transforms as credit_tf
    from analytics.fiscal_policy import transforms as fiscal_tf
