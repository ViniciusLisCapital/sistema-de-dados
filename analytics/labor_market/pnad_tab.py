...
ja usado por analytics/fiscal_policy/gfsm_tab.py (makeHierTab() no lado JS, aqui
...
curto prazo/Var. anual pre-computados em Python (analytics/labor_market/
...
uma v2 -- ver Pending em analytics/labor_market/CLAUDE.md.
"""
from analytics.credit import tree_helpers as th
from analytics.labor_market import transforms as tf
