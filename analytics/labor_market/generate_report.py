...
autocontido. Mesmo padrao /*REPORT_DATA*/ de analytics/fiscal_policy/ e
analytics/economic_activity/ -- sem Jinja2, via
...
from analytics.labor_market import caged_tab, pnad_tab
...
def _load_pnad_tab_data() -> dict:
    """Abas Taxas/Ocupacao/Rendimento -- ver analytics/labor_market/pnad_tab.py."""
...
def _load_caged_tab_data() -> dict:
    """Aba Emprego Formal -- ver analytics/labor_market/caged_tab.py."""
