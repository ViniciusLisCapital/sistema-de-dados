...
from analytics.exchange_rate.models import fx_attribution_model as fx
...
def build_story():
    ...
    story.append(Paragraph(
        "Todo modelo em <i>analytics/exchange_rate/models/</i> — UIP, carry, o modelo de desvio bayesiano, o "
    ...
    story.append(Paragraph(
        ...
        "<i>analytics/exchange_rate/CLAUDE.md</i>; código em <i>fx_attribution_model.py</i> (pasta "
