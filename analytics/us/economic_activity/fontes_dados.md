...
[`analytics/brasil/labor_market/fontes_dados.md`](../../brasil/labor_market/fontes_dados.md). Access status
for every source, and the two API keys we still need, are in [`us/CLAUDE.md`](../CLAUDE.md); this file
covers only what the activity branch needs. Brazil counterpart:
[`analytics/brasil/economic_activity/CLAUDE.md`](../../brasil/economic_activity/CLAUDE.md).
...
| Construction spending | **Census** | ✅ `TTLCONS`, `PRRESCONS`, `TLRESCONS` | 🔑 Census | FRED | ❌ | Residential detail also appears in [`us/housing/fontes_dados.md`](../housing/fontes_dados.md) |
...
| Trade balance and current account | **Census/BEA** | ✅ `BOPGSTB`, `IEABC`, `NETFI` | 🔑 both | FRED | ❌ | Detail lives in [`us/external_sector/fontes_dados.md`](../external_sector/fontes_dados.md) |
