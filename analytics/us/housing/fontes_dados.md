...
access status: [`us/CLAUDE.md`](../CLAUDE.md).
...
| Mortgage debt service burden | **Fed Board** | ✅ `MDSP` (quarterly, 2005-01→) | ✅ | FRED | ❌ | Also in [`us/credit/fontes_dados.md`](../credit/fontes_dados.md) |
...
| Residential fixed investment | **BEA** | ✅ `PRFIC1` (quarterly, real) | 🔑 BEA | FRED | ❌ | The GDP-consistent measure; see [`us/economic_activity/fontes_dados.md`](../economic_activity/fontes_dados.md) |
