...
[`analytics/brasil/fiscal_policy/fontes_dados.md`](../../brasil/fiscal_policy/fontes_dados.md), the Brazil
counterpart of this branch. Cross-cutting access status: [`us/CLAUDE.md`](../CLAUDE.md).
...
| Debt by holder | **Treasury** | ✅ `FYGFDPUN` (public), `FDHBFIN` (foreign), `FDHBPIN` (private), `FDHBFRBN` (Federal Reserve) | ✅ TIC for the foreign detail | FRED / csv | ❌ | `FDHBFIN` lags the others (ends 2025-10 vs. 2026-01). Country-level foreign holdings are in [`us/external_sector/fontes_dados.md`](../external_sector/fontes_dados.md) |
