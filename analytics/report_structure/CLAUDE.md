...
|---|---|---|
| `builder.py` | `render_report(template_path, data, output_path)` — reads the template, JSON-serializes `data`, substitutes markers, writes the output, returns the resolved `Path` | — |
