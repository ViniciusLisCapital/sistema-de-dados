...
x Nominal/Real usados pelas tabelas interativas de analytics/credit/ (abas Saldo,
...
Convencao de ajuste sazonal (mesma de analytics/inflation/fetch_bcb.py — ver
.claude/rules/lis-dashboards.md e analytics/inflation/CLAUDE.md): STL com fatores
...
def moving_average(values: list, window: int) -> list:
    ...
    analytics/inflation/fetch_bcb.py's _apply_stl_ma3."""
    vals = pd.Series(values, dtype="float64")
