...
/*REPORT_DATA*/ de analytics/brasil/inflation/ e analytics/brasil/exchange_rate/ -- sem
Jinja2, via analytics.report_structure.builder.render_report().

Uso:
    uv run python analytics/brasil/economic_activity/generate_report.py
...
def run(output: str = "reports/brasil/Economic Activity.html") -> None:
