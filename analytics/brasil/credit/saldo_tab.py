...
Nominal/Real ja pre-computadas em Python (ver analytics/brasil/credit/transforms.py) — o
...
analytics/brasil/credit/fontes_dados.md) — nunca se soma series de crescimento/percentual
...
# Aliases -- ver analytics/report_structure/tree_helpers.py (compartilhado com concessao_tab.py).
