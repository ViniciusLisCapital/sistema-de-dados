...
analytics/brasil/monetary_policy/referencia/MODEL_REPLICATION_PLAN.md. Summary:
...
Source equations: analytics/brasil/monetary_policy/referencia/modelo_agregado.pdf
