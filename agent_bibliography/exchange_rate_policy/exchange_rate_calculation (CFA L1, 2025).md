...
$$\frac{\text{CAD}}{\text{USD}}^{-1} \times \frac{\text{JPY}}{\text{USD}} = \frac{\text{USD}}{\text{CAD}} \times \frac{\text{JPY}}{\text{USD}} = \frac{\text{JPY}}{\text{CAD}}$$
...
#### Question 1: Spot CHF/EUR Cross-Rate
...
$$\frac{\text{CHF}}{\text{EUR}} = \frac{\text{CHF}}{\text{USD}} \times \frac{\text{USD}}{\text{EUR}} = 1.1701 \times 0.9900 = 1.1584$$

#### Question 2: Spot GBP/EUR Cross-Rate
...
$$\frac{\text{GBP}}{\text{EUR}} = \frac{\text{USD}}{\text{EUR}} \times \frac{\text{GBP}}{\text{USD}}^{-1} = \frac{1.1701}{1.3118} = 0.8920$$

#### Question 3: Euro Appreciation Against USD

Based on the research report, the euro is expected to appreciate by how much against the US dollar over the next year?
- A. –0.7 percent
- B. +0.7 percent
- C. +1.0 percent
...
#### Question 4: USD Appreciation Against GBP
...
$$\frac{1}{1.3066} - \frac{1}{1.3118} = +0.4\%$$

#### Question 5: Swiss Franc Movement
...
#### Question 6: Currency Strength Ranking
...
#### Question 7: Currency Appreciation Ranking
...
$$1.15885 \times (1 + 0.698\%) = 1.15885 \times (1.00698) \approx 1.16694$$
...
$$(1 + r_d) = \frac{1}{S_{d/f}}(1 + r_f)F_{d/f}$$
...
$$F_{f/d} = 1.6535 \times \frac{1.0500}{1.0350} = 1.6775$$

### Detecting Mispriced Forward Rates
...
$$S_{f/d}(1 + r_f)\left(\frac{1}{F_{f/d}}\right) = 1.6535(1.05)\frac{1}{1.6900} = 1.0273$$
...
### Forward Premium/Discount and Interest Rate Differential
...
### Caveats on Interpreting Forward Rates
...
$$F_{f/d} - S_{f/d} = S_{f/d}\frac{r_f - r_d}{1 + r_d\tau}\tau$$
...
#### Practical Example: 30-Day Forward Rate
...
$$F_{f/d} = S_{f/d}\frac{1 + r_f\left[\frac{30}{360}\right]}{1 + r_d\left[\frac{30}{360}\right]} = 1.6555 \times \frac{1 + 0.0300\left[\frac{30}{360}\right]}{1 + 0.0200\left[\frac{30}{360}\right]} = 1.6569$$
...
$$F_{f/d} - S_{f/d} = S_{f/d}\frac{r_f - r_d}{1 + r_d\tau}\tau = 1.6555 \times \frac{0.0300 - 0.0200}{\left(1 + 0.0200\left[\frac{30}{360}\right]\right)}\left[\frac{30}{360}\right] = 0.0014$$

#### Relationship Between Forward Points and Maturity
...
$$F_{f/d} - S_{f/d} = 1.6555 \times \frac{0.0300 - 0.0200}{1 + 0.0200\left[\frac{180}{360}\right]}\left[\frac{180}{360}\right] = 0.0082$$
...
#### Relationship Between Forward Points and Interest Rate Differential
