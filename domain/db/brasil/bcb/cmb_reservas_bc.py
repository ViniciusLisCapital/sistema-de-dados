...
Schema macro_brasil.cmb_reservas_bc:
...
DDL:
  DROP TABLE IF EXISTS macro_brasil.cmb_reservas_bc;
  CREATE TABLE macro_brasil.cmb_reservas_bc (
      date      DATE           NOT NULL,
...
def run(n_meses: int = 3, start: str | None = None, end: str | None = None) -> None:
    """Atualiza macro_brasil.cmb_reservas_bc.
