...
Schema macro_brasil.cambio_contratado:
  PRIMARY KEY (date, sgs_code)
  Colunas: date DATE | sgs_code INT | name VARCHAR(100) | value DECIMAL(20,6)

DDL:
  DROP TABLE IF EXISTS macro_brasil.cambio_contratado;
  CREATE TABLE macro_brasil.cambio_contratado (
      date      DATE           NOT NULL,
...
def run(n_meses: int = 3, start: str | None = None, end: str | None = None) -> None:
    """Atualiza macro_brasil.cambio_contratado.
