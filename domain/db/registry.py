...
`_TABLE = "<nome>"` (ou `TABLE`) e vive num arquivo com exatamente esse nome — 76 de
76 seguem isso, verificado (o 77o arquivo e o `mt_caged_novo`, orquestrador que nao
...
inteiro puxaria pandas/mysql/requests de 70+ modulos so para montar um dicionario.
